# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 14:24:04 2021
...
class RandomForest:
    ...
    def __init__(self, df, RandomAttributes, HandleUnknowns=False, CompleteDataSet=None):
    ...
    def __AppendTree(self):
        ...
        currTree.BuildFromDataFrame(df_boot, num_rows, 2, None, self.__HandleUnknowns, CompleteDataSet, self.RandomAttributes)
